...
public class NamaAdminController07096 implements ControllerInterface07096{
    ...
    public void login(String Admin, String Password) {
        indexLogin = AllObjectModel07096.adminModel.cekData(Admin,Password);
    }
    public NamaAdmin07096 adminEntity() {
        return AllObjectModel07096.adminModel.showData(indexLogin);
    }
