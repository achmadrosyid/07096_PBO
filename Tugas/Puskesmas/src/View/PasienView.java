...
public class PasienView {
    ...
    JComboBox pilihpoli = new JComboBox(PoliEntity.nama);
    ...
    public PasienView() {
        ...
        Pasien.add(labelnik);
        textnik = new JTextField(Integer.toString(AllObjController.
                pasien.pasienEntity().getNik()));
        ...
        textnama = new JTextField(AllObjController.pasien.pasienEntity().getNama());
        textnama.setBounds(30, 160, 250, 30);
        Pasien.add(textnama);
        labelpassword = new JLabel("Password");
        labelpassword.setBounds(30, 190, 100, 30);
        Pasien.add(labelpassword);
        textpassword = new JPasswordField(AllObjController.
                pasien.pasienEntity().getPassword());
        ...
        textnotelp = new JTextField(AllObjController.pasien.pasienEntity().getNo_telp());
        ...
        texttgllahir = new JTextField(new SimpleDateFormat("dd/MM/YYYY")
                .format(AllObjController.pasien.pasienEntity().getTgllahir()));
        ...
        textalamat = new JTextField(AllObjController.pasien.pasienEntity().getAlamat());
        ...
        textjeniskelamin = new JTextField(AllObjController.
                pasien.pasienEntity().getJeniskelamin());
        ...
        EditPasien.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                try {
                    ...
                    AllObjController.pasien.postData(pass, 
                            nama, notelp, alamat, jeniskelamin, nik, tgllahir, "editPasien");
                    JOptionPane.showMessageDialog(null, "Update Data Sukses", 
                            "information", JOptionPane.INFORMATION_MESSAGE);
                } catch (Exception exception) {
                    JOptionPane.showMessageDialog(null, "Format Penulisan Salah", 
                            "Update Data Gagal", JOptionPane.INFORMATION_MESSAGE);
                }
            }
        });
        ...
        Antri.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                try {
                    AllObjController.pasien.registerAntrian(indexpoli,
                            AllObjController.pasien.pasienEntity());
                    System.out.println("Anda Sudah Terdaftar Di Poli = "
                            + AllObjController.pasien.showNamePoli(indexpoli));
