...
public class DokterView {
    ...
    JButton back;
    JLabel titleHeader;
    private int IndexPoli = AllObjController.dokter.dokterEntity().getPoli();
    ...
    public DokterView() {
        ...
        tabelAntrianPasien.setModel(AllObjController.pasien.antrianPasien(IndexPoli));
        ...
        tabelAntrianPasien.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                int ok = JOptionPane.showConfirmDialog(null, 
                        "Yakin Mau Hapus Antrian Ke - " + i + 
                                " ?", "Konfirmasi", JOptionPane.YES_NO_OPTION);
                if (ok == 0) {
                    AllObjController.dokter.deleteListAntrianPasien(i);
                }
                tabelAntrianPasien.setModel(AllObjController.pasien.antrianPasien(IndexPoli));
            }
        }
